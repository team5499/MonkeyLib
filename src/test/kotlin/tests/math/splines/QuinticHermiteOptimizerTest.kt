...
class QuinticHermiteOptimizerTest {
    ...
    fun testOptimizer() {
        // test porabola thing
        val t = FunctionalQuadraticSpline(Vector2d(-1.0.meters, 0.015.meters), Vector2d(0.0.meters, 0.015.meters), Vector2d(1.0.meters, 0.016.meters)).vertexXCoordinate
        assertEquals(t.value, -0.5, 0.1)

        val a = Pose2d(Vector2d(0.meters, 100.meters), 270.degrees)
        val b = Pose2d(Vector2d(50.meters, 0.meters), 0.degrees)
        val c = Pose2d(Vector2d(100.meters, 100.meters), 90.degrees)

        val d = Pose2d(Vector2d(0.meters, 0.meters), 90.degrees)
        val e = Pose2d(Vector2d(0.meters, 50.meters), 0.degrees)
        val f = Pose2d(Vector2d(100.meters, 0.meters), 90.degrees)
        val g = Pose2d(Vector2d(100.meters, 100.meters), 0.degrees)

        val h = Pose2d(Vector2d(0.meters, 0.meters), 0.degrees)
        val i = Pose2d(Vector2d(50.meters, 0.meters), 0.degrees)
        val j = Pose2d(Vector2d(100.meters, 50.meters), 45.degrees)
        val k = Pose2d(Vector2d(150.meters, 0.meters), 270.degrees)
        val l = Pose2d(Vector2d(150.meters, -50.meters), 270.degrees)
