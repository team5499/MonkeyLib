...
import org.team5499.monkeyLib.hardware.AbstractMonkeyMotor
...
abstract class CTREMonkeyMotor<T : SIUnit<T>> internal constructor(
    val motorController: IMotorController,
    val model: NativeUnitModel<T>
) : AbstractMonkeyMotor<T>() {

    private var mLastDemand = Demand(ControlMode.Disabled, 0.0, DemandType.Neutral, 0.0)

    override val encoder = CTREMonkeyEncoder(motorController, 0, model)
